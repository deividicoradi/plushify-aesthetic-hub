...
export const pricingPlans: PlanConfig[] = [
  {
    ...
    features: [
      ...
      { included: false, text: 'Marketing automatizado' },
  ...
  },
  {
    ...
    features: [
      ...
      { included: false, text: 'Relatórios avançados com IA' },
      { included: false, text: 'Marketing automatizado' },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { included: true, text: 'Relatórios avançados com IA' },
      { included: true, text: 'Marketing automatizado básico' },
      { included: true, text: 'Campanhas de WhatsApp/SMS' },
      { included: true, text: 'Sistema de fidelidade' },
      { included: true, text: 'Análises preditivas' },
      { included: true, text: 'Integração com redes sociais' },
      { included: true, text: 'Cursos e certificações' },
      { included: false, text: 'Gestão de equipe multi-usuário' },
      { included: false, text: 'IA personalizada para seu negócio' },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      { included: true, text: 'Gestão de equipe multi-usuário' },
      { included: true, text: 'IA personalizada para seu negócio' },
      { included: true, text: 'Automação avançada com IA' },
      { included: true, text: 'CRM completo integrado' },
      { included: true, text: 'Sistema de vendas e comissões' },
      { included: true, text: 'Biolink personalizado' },
      { included: true, text: 'Programa de afiliados' },
      { included: true, text: 'API personalizada' },
      { included: true, text: 'Relatórios personalizados' },
      { included: true, text: 'Exportação avançada (PDF/Excel)' },
      { included: true, text: 'Integração com ERPs' },
      { included: true, text: 'Consultoria estratégica mensal' },
      { included: true, text: 'Suporte prioritário 24/7' },
      { included: true, text: 'Treinamento da equipe incluído' },
    ],
