      ...
      <div className="flex h-screen bg-gray-50 dark:bg-background">
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-50 md:hidden">
            ...
            />
            <div className="fixed inset-y-0 left-0 w-64 bg-white dark:bg-background">
              <DashboardSidebar />
            </div>
          </div>
        )}
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          {/* Top Navigation */}
          <header className="bg-white dark:bg-background border-b border-gray-200 dark:border-border h-16 flex items-center justify-between px-4">
