  ...
  return (
    <div className="space-y-6">
          ...
          <CardContent className="pt-0">
            <div className="space-y-3">
              ...
              {[
                ...
                <div
                  key={item.id}
                  className="flex items-center justify-between p-3 bg-card rounded-lg border cursor-pointer hover:bg-muted/50 transition-colors group"
        ...
        <CardContent className="pt-0">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1" className="border-border">
              <AccordionTrigger className="hover:text-primary">Como adicionar um novo cliente?</AccordionTrigger>
            ...
            <AccordionItem value="item-2" className="border-border">
              <AccordionTrigger className="hover:text-primary">Como criar um novo agendamento?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground bg-muted/30 p-4 rounded-lg border">
            ...
            <AccordionItem value="item-3" className="border-border">
              <AccordionTrigger className="hover:text-primary">Como atualizar meu plano?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground bg-muted/30 p-4 rounded-lg border">
            ...
            <AccordionItem value="item-4" className="border-border">
              <AccordionTrigger className="hover:text-primary">Como usar o sistema de fidelidade?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground bg-muted/30 p-4 rounded-lg border">
            ...
            <AccordionItem value="item-5" className="border-border">
              <AccordionTrigger className="hover:text-primary">Como gerenciar meu estoque?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground bg-muted/30 p-4 rounded-lg border">
      ...
      <div id="dashboard-help">
        <Card className="border shadow-sm">
          <CardHeader className="pb-4"><CardTitle>Como usar o Dashboard</CardTitle></CardHeader>
      ...
      <div id="clients-help">
        <Card className="border shadow-sm">
          <CardHeader className="pb-4"><CardTitle>Gestão de Clientes</CardTitle></CardHeader>
          <CardContent className="space-y-4">
      ...
      <div id="appointments-help">
        <Card className="border shadow-sm">
          <CardHeader className="pb-4"><CardTitle>Sistema de Agendamentos</CardTitle></CardHeader>
          <CardContent className="space-y-4">
      ...
      <div id="financial-help">
        <Card className="border shadow-sm">
          <CardHeader className="pb-4"><CardTitle>Controle Financeiro</CardTitle></CardHeader>
          <CardContent className="space-y-4">
      ...
      <div id="services-help">
        <Card className="border shadow-sm">
          <CardHeader className="pb-4"><CardTitle>Cadastro de Serviços</CardTitle></CardHeader>
          <CardContent className="space-y-4">
      ...
      <div id="inventory-help">
        <Card className="border shadow-sm">
          <CardHeader className="pb-4"><CardTitle>Gestão de Estoque</CardTitle></CardHeader>
          <CardContent className="space-y-4">
