    ...
    return (
      <Card className="border-0 shadow-lg mb-6">
        <CardHeader className="pb-3 border-b">
          <CardTitle className="text-xl font-serif text-pink-700">Alertas de Estoque</CardTitle>
        </CardHeader>
      ...
      <CardContent className="pt-4">
        ...
        <div className="space-y-3">
          {lowStockProducts.slice(0, 5).map(product => (
            <div key={product.id} className="flex items-center justify-between p-3 border rounded-lg bg-pink-50/70">
              <div>
