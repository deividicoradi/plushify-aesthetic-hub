...
CREATE TABLE public.client_gift_cards (
...
CREATE INDEX idx_client_gift_cards_client ON public.client_gift_cards(client_id, status);
...
CREATE INDEX idx_gift_card_redemptions_card ON public.gift_card_redemptions(client_gift_card_id);
...
CREATE INDEX idx_payments_client_gift_card ON public.payments(client_gift_card_id) WHERE client_gift_card_id IS NOT NULL;
